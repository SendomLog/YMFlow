...
#import <YMFlow/YMFlowTask.h>
#import "CommandID.h"
#import <YMFlow/YMFNetworkService.h>
#import "Constants.h"
#import <YMFlow/YMFLogUtil.h>
...
- (void)viewDidLoad {
    ...
    [[YMFNetworkService sharedInstance] addPushObserver:self withCmdId:kPushMessageCmdId];
}
...
-(NSData*)req2buf {
    ...
    YMFLOG_INFO(kYMFlowTAG, @"send msg to topic:%@", _conversation.notice);
...
- (void)sendMessage {
    YMFlowTask *sendMsgCGI = [[YMFlowTask alloc] initAll:YMFTaskChannelType_LongConn andCmdId:kSendMsg andCGIUri:@"/mars/sendmessage" andHost:@"www.marsopen.cn"];
    [[YMFNetworkService sharedInstance] startTask:sendMsgCGI forTaskNotify:self];
}
